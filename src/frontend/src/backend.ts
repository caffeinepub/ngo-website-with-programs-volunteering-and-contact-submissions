...
import type { ContactMessage as _ContactMessage, DonationPledge as _DonationPledge, UserProfile as _UserProfile, UserRole as _UserRole, VolunteerInterest as _VolunteerInterest } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getContactMessageByEmail(arg0: string): Promise<ContactMessage | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getContactMessageByEmail(arg0);
    ...
    async getDonationPledgeByEmail(arg0: string): Promise<DonationPledge | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDonationPledgeByEmail(arg0);
    ...
    async getVolunteerInterestByEmail(arg0: string): Promise<VolunteerInterest | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getVolunteerInterestByEmail(arg0);
    ...
    async listDonationPledges(): Promise<Array<DonationPledge>> {
        if (this.processError) {
            try {
                const result = await this.actor.listDonationPledges();
    ...
    async listVolunteerInterests(): Promise<Array<VolunteerInterest>> {
        if (this.processError) {
            try {
                const result = await this.actor.listVolunteerInterests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDonationPledge(arg0: DonationPledge): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDonationPledge(to_candid_DonationPledge_n17(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitVolunteerInterest(arg0: VolunteerInterest): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitVolunteerInterest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_DonationPledge_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DonationPledge): DonationPledge {
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DonationPledge]): DonationPledge | null {
    return value.length === 0 ? null : from_candid_DonationPledge_n11(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_VolunteerInterest]): VolunteerInterest | null {
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ContactMessage]): ContactMessage | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DonationPledge>): Array<DonationPledge> {
    return value.map((x)=>from_candid_DonationPledge_n11(_uploadFile, _downloadFile, x));
}
function to_candid_DonationPledge_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DonationPledge): _DonationPledge {
